function syncPayload(){return {hp:playerProfile.hp,grayHp:playerProfile.grayHp||0,san:playerProfile.san,level:playerProfile.level,xp:playerProfile.xp,gold:playerProfile.gold!==undefined?playerProfile.gold:100,combo:playerProfile.combo,wonRounds:playerProfile.wonRounds,gachaCards:playerProfile.tarotCardsCollected||[],marks,customWords,novelProgress,novelSaves:novelSaveSlots,riskModel:playerProfile.riskModel||null,learningEvidence:playerProfile.learningEvidence||{}};}
...
async function initCloudSession() {
  ...
  try {
    ...
    if (resp.ok) {
      ...
      playerProfile.gold = Math.max(playerProfile.gold || 0, cloud.gold || 0);
      playerProfile.wonRounds = Math.max(playerProfile.wonRounds || 0, cloud.wonRounds || 0);
      if (cloud.learningEvidence && typeof cloud.learningEvidence === 'object') {
        playerProfile.learningEvidence = Object.assign({}, cloud.learningEvidence, playerProfile.learningEvidence || {});
      }
